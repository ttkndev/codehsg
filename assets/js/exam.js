...
const card = i => {
  ...
  <div class="col-4"><i class="bi bi-file-earmark-pdf"></i> ${String(i.file_ext || 'pdf').toUpperCase()}</div>
  <div class="col-4"><i class="bi bi-list-ol"></i> ${i.problem_count || 0} bài</div>
  <div class="col-4"><i class="bi bi-clock"></i> ${i.duration || '-'}</div>
</div>

<div class="row exam-stats mb-2">
  <div class="col-4"><i class="bi bi-mortarboard"></i> ${i.grade || 'Khác'}</div>
  <div class="col-4"><i class="bi bi-person"></i> ${i.contributor || 'admin'}</div>
  <div class="col-4"><i class="bi bi-database"></i> ${i.file_size || '-'}</div>
</div>

<div class="row exam-stats mb-2">
  <div class="col-4"><i class="bi bi-eye"></i> ${(i.view_count || 0).toLocaleString('vi-VN')}</div>
  <div class="col-4"><i class="bi bi-download"></i> ${(i.download_count || 0).toLocaleString('vi-VN')}</div>
  <div class="col-4"><i class="bi bi-calendar"></i> ${i.date_added || '-'}</div>
</div>
